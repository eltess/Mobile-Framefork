...
public class Capabilities {
    ...
    private static final SauceLabsConfiguration SAUCE_LABS_CONFIGURATION = ConfigFactory.create(SauceLabsConfiguration.class);

    public static DesiredCapabilities get() {
        return  "saucelabs".equals(UI_CONFIGURATION.executionPlatform()) ? getSauceLabsCapabilities() : getLocalCapabilities();
    }
